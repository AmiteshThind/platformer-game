...
public class Healthbar : MonoBehaviour {
    ...
    [Tooltip("Health variable: (default range: 0-100)")] public float health = 2000;

    
    private int healthPercentage = 2000; // based on scaling of player decreasing by 0.001 everytime it moves 

    // Minimum possible heath:
    [Tooltip("Minimum possible heath: (default is 0)")] public float minimumHealth = 0;

    // Maximum possible health:
    [Tooltip("Maximum possible heath: (default is 100)")] public float maximumHealth = 2000;

    // If the character has this health or less, consider them having low health:
    [Tooltip("Low health is less than or equal to this:")] public int lowHealth = 1400;
    ...
    [Tooltip("High health is greater than or equal to this:")] public int highHealth = 700;
    ...
    private void Update()
    {
        healthPercentage = int.Parse((Mathf.Round(maximumHealth * (health / maximumHealth))).ToString());
